...
node[:hadoop][:namenode   ][:addr] = namenode.private_ip rescue nil
node[:hadoop][:jobtracker ][:addr] = jobtracker.private_ip rescue nil
node[:hadoop][:secondarynn][:addr] = secondarynn.private_ip rescue nil
