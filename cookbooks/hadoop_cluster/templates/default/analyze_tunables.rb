...
class Mapred < Tunable
  # Mapper tuning
  field :io_sort_mb,               :integer, units: 'megabyte',     hadoop_1: ''
  field :io_sort_record_frac,      :float,   units: 'frac',         hadoop_1: ''
  field :io_sort_spill_frac,       :float,   units: 'frac',         hadoop_1: ''
  field :min_split_size,           :integer, units: 'byte',         hadoop_1: ''

  # Reducer tuning
  field :io_sort_factor,           :integer, units: '',             hadoop_1: ''
  field :shuffle_heap_frac,        :float,   units: '',             hadoop_1: ''
  field :shuffle_merge_frac,       :float,   units: '',             hadoop_1: ''
  field :reduce_heap_frac,         :float,   units: '',             hadoop_1: ''
  field :reducer_parallel_copies,  :integer, units: '',             hadoop_1: ''

  # Child jobs
  field :max_map_tasks,            :integer,                        hadoop_1: ''
  field :max_reduce_tasks,         :integer,                        hadoop_1: ''
  field :map_heap_mb,              :integer, units: 'megabyte',     hadoop_1: ''
  field :reduce_heap_mb,           :integer, units: 'megabyte',     hadoop_1: ''
  field :java_child_ulimit,        :integer, units: 'byte',         hadoop_1: ''
  field :java_child_opts,          :string,                         hadoop_1: ''
  field :java_map_opts,            :string,                         hadoop_1: ''
  field :java_reduce_opts,         :string,                         hadoop_1: ''

  # Compression
  field :compress_mapout_codec,    :string,                         hadoop_1: ''
  field :compress_output_codec,    :string,                         hadoop_1: ''
  field :codecs,                   :array, of: :string,             hadoop_1: ''

  # Scheduling
  field :map_speculative_exec,     :boolean, units: '',             hadoop_1: ''
  field :reduce_speculative_exec,  :boolean, units: '',             hadoop_1: ''
  field :slowstart_frac,           :float,   units: 'frac',         hadoop_1: ''
  field :task_scheduler,           :string,  units: '',             hadoop_1: ''

  # Ergonomics
  field :trash_interval,           :integer, units: 'minute',       hadoop_1: ''
  field :dashboard_is_admin,       :boolean, units: '',             hadoop_1: ''
  field :balancer_max_bandwidth,   :integer, units: 'byte_per_sec', hadoop_1: ''



  field :mapper_min_split_mb,       :integer, hadoop_1: 'mapred.min.split.size'
  #
  field :mapper_sortbuf_acct_mem,   :integer
  field :mapper_sortbuf_data_mem,   :integer
  field :mapper_sortbuf_total_mem,  :integer, hadoop_1: 'io.sort.mb'
  field :mapper_sortbuf_acct_frac,  :integer, hadoop_1: 'io.sort.record.percent', default: 0.05 do
    mapper_sortbuf_acct_mem / mapper_sortbuf_total_mem
  end
  field :mapper_sortbuf_spill_frac, :integer, hadoop_1: 'io.sort.spill.percent', default: 0.8
end
